...
public class Ranking_adFragment extends Fragment {
    ...
    public static Ranking_adFragment newInstance(){
        Ranking_adFragment ranking_adFragment = new Ranking_adFragment();
        return ranking_adFragment;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_ranking_ad,container,false);

        ll = myFragment.findViewById(R.id.scoreRecycle1);
    ...
    private void loadCategory() {
        ...
        String url = Category.BASE_URL+"get_score.php?";
